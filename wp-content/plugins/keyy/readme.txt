...
Contributors: DavidAnderson, aporter, lumberhack, dnutbourne
...
* PERFORMANCE: Stop polling for scans when the browser visibility API indicates that the screen is
...
== Upgrade Notice ==
* 0.7.3 - New shortcode, better performance, improved UI
